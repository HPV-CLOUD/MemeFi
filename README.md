...
# 🟣 MemeFi AutoBot /// HPV /// V3.01 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *автоматизирует действия, которые вы обычно выполняете вручную **([СКРИНШОТ](https://telegra.ph/file/69f8c30dba2603deb09d3.png))**:*<br>**—** *Апгрейд текущего босса*;<br>**—** *Улучшение бустов: `Damage`, `EnergyCap` и `EnergyRechargeRate`*;<br>**—** *Если TapBot уже приобретен - происходит сбор монет и перезапуск бота каждые 3-4 часа*;<br>**—** *Если TapBot отсутствует - происходит его приобретение*;<br>**—** *Прокрут спинов*;<br>**—** *Ожидание от 9 до 12 часов*;<br>**—** *Повторение действий через 9-12 часов.<br>Все действия выполняются в случайном порядке каждый раз, когда скрипт начинает сбор. Также добавлены пустые функции: просмотра рефералов, просмотра глобальной лиги, просмотра клана, просмотра кошелька и просмотра заданий для большей правдоподобности* |✅|
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    git clone https://github.com/HPV-CLOUD/MemeFi
    ```
  - ```
    pip3 install HPV_TEAM_MemeFi
    ```
- **Windows**
